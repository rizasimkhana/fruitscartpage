...
function App() {
  ...
  const Products=[
    ...
    {id:4,name:"pineapples",image:"https://images2.minutemediacdn.com/image/upload/c_crop,w_6000,h_3375,x_0,y_482/v1684341694/images/voltaxMediaLibrary/mmsport/mentalfloss/01h0n9d2b8aet9amr049.jpg",description:"Fresh pineapples",price:150},
    {id:5,name:"watermelon",image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvg01M7DXooe2LsGFoCVITVzz1twBUO7QZ-g&s",description:"Fresh watermelons",price:290},
    {id:6,name:"pear",image:"https://www.producemarketguide.com/media/user_RZKVrm5KkV/22476/pears_commodity-page.png",description:"Fresh pear",price:290},
